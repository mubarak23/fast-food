        ...
        <>
          <div className="side-menu">
                ...
                <label className="inline-flex items-center mt-3">
                     <input onChange={(e) => props.change(e,"price") } type="checkbox" 
                     className="cursor-pointer h-8 w-8 form-tick text-white appearance-none
                      border border-gray-300 rounded-md checked:bg-gray-600 checked:border-transparent
                       text-center focus:outline-none p-1" defaultValue="100-5000"/>
                       <span className="ml-2 text-gray-700">₦100 - ₦5000</span>
                    </label>
                    <label className="inline-flex items-center mt-3">
                     <input onChange={(e) => props.change(e,"price") } type="checkbox" 
                     className="cursor-pointer h-8 w-8 form-tick text-white appearance-none
                      border border-gray-300 rounded-md checked:bg-gray-600 checked:border-transparent
                       text-center focus:outline-none p-1" defaultValue="5100-10000"/>
                       <span className="ml-2 text-gray-700">₦5100 - ₦10000</span>
                    </label>
                    <label className="inline-flex items-center mt-3">
                     <input  onChange={(e) => props.change(e,"price") }type="checkbox"
                      className="cursor-pointer h-8 w-8 form-tick text-white appearance-none
                       border border-gray-300 rounded-md checked:bg-gray-600 checked:border-transparent 
                       text-center focus:outline-none p-1" defaultValue="10100-15000"/>
                       <span className="ml-2 text-gray-700">₦10100 - ₦15000</span>
                    </label>
                    <label className="inline-flex items-center mt-3">
                     <input onChange={(e) => props.change(e,"price") } type="checkbox" 
                     className="cursor-pointer h-8 w-8 form-tick text-white appearance-none
                      border border-gray-300 rounded-md checked:bg-gray-600 checked:border-transparent 
                      text-center focus:outline-none p-1" defaultValue="15100-20000"/>
                      <span className="ml-2 text-gray-700">₦15100 - ₦20000</span>
                    </label>
                    <label className="inline-flex items-center mt-3">
