...
const Single = (props) => {
 ...
 <section>
    ...
    <div className="mb-5 p-6  text-lg font-bold  xl:hidden">
        ...
        <Shipping shipping={props.cart && props.cart.shippingData && props.cart.shippingData}
         change={handleFilterChange} errors={errors}/>
    ...
    <section className="w-full xl:w-3/12 my-8 xl:my-4">
        ...
        <Checkout header={`Subtotal `} qty={props.cartItems && props.cartItems.length} total={props.cart && props.cart.totalPrice} items={props.cart && props.cart.totalPrice} shipping={0} tax={0}>
