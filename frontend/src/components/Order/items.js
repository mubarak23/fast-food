  ...
  <div className="">
    ...
    <div className="mt-1 flex w-1/2 rounded-md shadow-sm">
      <span className="inline-flex items-center px-3 rounded-l-md border border-r-1 border-gray-300 bg-gray-50 text-gray-500 text-sm">
        ...
        <input onChange={(e) => props.change(e,"shipping")}  className=" py-2 px-2 border
         border-1 focus:outline-none focus:bg-white focus:border-gray-500 flex-1 block w-full 
         rounded-none rounded-r-md sm:text-sm border-gray-300" id="grid-name" type="name" 
         placeholder="Shipping details"/>

      </div>
    </div>
       <div className="shadow  border-b w-full  overflow-hidden 
       border-gray-200 sm:rounded-lg">
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              <th scope="col" className="px-6 py-3 bg-gray-50 text-left text-xs
              ...
              <th scope="col" className="px-6 py-3 bg-gray-50 text-left text-xs font-medium 
