        ...
        <StyledNavbar>
            <nav className="bg-gray-800">
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="ml-3 relative">
                            ...
                            <div className={menu?" origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 block" :"origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 hidden"} role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                                ...
                                <span onClick={() => logoutUser(props)} className="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sign out</span>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <span onClick={() => logoutUser(props)} className="cursor-pointer block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Sign out</span>
                    </div>
                </div>):''
                }
                </div>
